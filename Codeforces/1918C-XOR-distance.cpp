...
x < y
tambah bit ke x tapi tidak ke y

batasi iterasi sampai kurang dari bit 1 dari y terbesar tapi di x adalah 0

how to make sure that tot <= r
iterasi bit dari paling besar ke kecil
